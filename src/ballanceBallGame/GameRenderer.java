...
import ballanceBallGame.gameCharactor.GameCharactor;
import ballanceBallGame.gameCharactor.TargetFlag;
import ballanceBallGame.gameTools.GLTextureFactory;
...
public class GameRenderer implements GLSurfaceView.Renderer {
	private static GameRenderer gameRenderer=null;
	 //private GameMap gameMap;
	 private GameManager gameManager;
	// private GLTextures glt;
	 private Context context;
	 public static GameRenderer getInstance(MapDto mdto, Context context){
		 if(gameRenderer==null){
			 gameRenderer = new GameRenderer(mdto,context);
		 }
		 return gameRenderer;
	 }
   private GameRenderer(MapDto mdto, Context context) {
